  ...
  return (
    <section className=" max-w-7xl mx-auto">
      ...
      <form className=" mt-16 max-w-3xl" onSubmit={handleSubmit}>
        ...
        <div className=" mt-10 ">
          <p className=" mt-2 text-gray-600 text-[14px]">Once you have created a image you want,you can share with others in community</p>
          <button type='submit' className=" mt-3 text-white font-medium bg-[#6469ff] w-full rounded-md px-5 py-2.5 sm:w-auto text-center">
